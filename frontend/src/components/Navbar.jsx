...
import logo from "../assets/HealSlot_logo.svg"
...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gary-400'>
      ...
      <ul className='hidden md:flex items-start gap-5 font-medium'>
        ...
        <a target="_blank" href="" class="border px-5 text-xs py-1.5 rounded-full">Admin Panel</a>
      </ul>
